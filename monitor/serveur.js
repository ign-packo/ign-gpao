...
// Dans le cas d'un déploiement de la stack via docker les variables d'environnement URL_MONITOR, MONITOR_PORT, URL_API, API_PORT
// sont surchargées dans le docker-compose.yml.

// Nom du serveur d'un point de vue client nécessaires pour les requêtes vers l'api executé côté client
